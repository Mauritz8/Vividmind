...
std::vector<Move>
MoveGenerator::get_pseudo_legal_moves(MoveCategory move_category) const {
...
std::vector<Move>
MoveGenerator::get_pseudo_legal_moves(const Piece &piece,
...
std::vector<Move>
MoveGenerator::get_bishop_pseudo_legal_moves(const Piece &piece,
                                             MoveCategory move_category) const {
  std::vector<Move> moves;
...
std::vector<Move>
MoveGenerator::get_rook_pseudo_legal_moves(const Piece &piece,
                                           MoveCategory move_category) const {
  std::vector<Move> moves;
...
std::vector<Move>
MoveGenerator::get_queen_pseudo_legal_moves(const Piece &piece,
                                            MoveCategory move_category) const {
  std::vector<Move> moves;
...
std::vector<Move>
MoveGenerator::get_knight_pseudo_legal_moves(const Piece &piece,
                                             MoveCategory move_category) const {
...
std::vector<Move>
MoveGenerator::get_king_pseudo_legal_moves(const Piece &piece,
                                           MoveCategory move_category) const {
...
std::vector<Move>
MoveGenerator::get_pawn_pseudo_legal_moves(const Piece &piece,
                                           MoveCategory move_category) const {
  std::vector<Move> moves;
  moves.reserve(4);
...
std::vector<Move> MoveGenerator::get_pseudo_legal_moves_direction(
